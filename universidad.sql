...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2024 a las 01:34:57
...
CREATE TABLE `alumno` (
  ...
  `estadoAlumno` tinyint(1) NOT NULL
...
INSERT INTO `alumno` (`idAlumno`, `dniA`, `apellidoA`, `nombreA`, `fechaNacimientoA`, `estadoAlumno`) VALUES
(1, 12345678, 'Torres', 'Juan', '2000-01-01', 1),
(2, 23456789, 'Perez', 'Maria', '1999-02-02', 1),
(3, 34567890, 'Exploradora', 'Dora', '1990-03-03', 1);
...
CREATE TABLE `materia` (
  ...
  `añoM` int(11) NOT NULL,
  `estadoM` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `materia` (`idMateria`, `nombreM`, `añoM`, `estadoM`) VALUES
(1, 'MATEMATICA', 2024, 1),
(2, 'EDA', 2024, 1),
(3, 'WEB', 2024, 1),
(4, 'LABORATORIO', 2024, 1);
